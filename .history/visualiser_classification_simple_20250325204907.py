...
FICHIER_CLASSIFICATION = "chemin/vers/votre/classification_non_supervisee.tif"  # IMPORTANT: Remplacez par le chemin de votre fichier TIFF de classification non supervisée
