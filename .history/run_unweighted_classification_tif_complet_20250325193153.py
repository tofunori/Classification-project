"""
CLASSIFICATION SANS PONDÉRATION COMPLÈTE
=======================================
...
sauf les graphiques de pondération.
"""
...
def main():
    ...
    print("======================================================================")
    print(" CLASSIFICATION SANS PONDÉRATION AVEC GRAPHIQUES COMPLETS ")
    print("======================================================================")
    ...
    config = {
        ...
        "validation": {
            ...
            "class_column": "classvalue"  # Nom de la colonne de validation
        },
        "comparison": {
            "enabled": False
        },
    ...
    output_dir = os.path.join(r"D:\UQTR\Hiver 2025\Télédétection\TP3\resultats", f"classification_complete_{timestamp}")
